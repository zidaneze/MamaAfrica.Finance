...
/**
    ...
    MamaAfrica Finance
    Contract using solidity 7 for MamaAfrica
    
    
    ---------------------------------------------------------------------------
     
    'MamaAfrica' token contract
    
    Symbol          : MAMA3
    Name            : MamaAfrica Token (Test 3)
    ...
    2% fee auto moved to charity wallet (African Development Foundation)
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xBAD3D1B852514a4f461bD266C3Fc0949E8732abc;
...
contract MAMA3 is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xe35247AdcdF466d22bd1FbFAad1a76E0F95FD01e;
    ...
    string private _name = "MamaAfrica3";
    string private _symbol = "MAMA3";
